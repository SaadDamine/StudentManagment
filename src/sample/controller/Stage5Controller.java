...
public class Stage5Controller implements Initializable {
    ...
    void add(ActionEvent event) {
        if (!Main.isInputValid(mail, "^(.+)@(.+)$")) {
            return;
        }
        String mail = this.mail.getText().toLowerCase().trim();
        Student std;
